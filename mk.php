...
<body>
    ...
    <div class="container-fluid bg-primary py-5 px-0" style="margin-bottom: 90px;">
        <div class="container">
            ...
            <h1>Welcome to MMK Institute</h1>
            
            <p>At MMK Institute, we are committed to providing high-quality IT education and training to help individuals advance their careers and achieve their professional goals. Our comprehensive courses cover a wide range of IT disciplines, from programming and web development to cybersecurity and data science.</p>
            
            <h2><i class="fas fa-cogs icon"></i> Our Services</h2>
            <ul>
                <li><i class="fas fa-laptop-code icon"></i> <strong>Programming Courses:</strong> Learn programming languages and frameworks with industry experts.</li>
                <li><i class="fas fa-code icon"></i> <strong>Web Development:</strong> Master web development skills with hands-on training.</li>
                <li><i class="fas fa-mobile-alt icon"></i> <strong>Mobile App Development:</strong> Turn app ideas into reality with our mobile app development courses.</li>
                <li><i class="fas fa-chart-bar icon"></i> <strong>Data Science and Analytics:</strong> Dive into the world of data science and analytics.</li>
                <li><i class="fas fa-shield-alt icon"></i> <strong>Cybersecurity Training:</strong> Protect digital assets and secure networks with our cybersecurity programs.</li>
                
            </ul>
            
            <p>Whether you're a beginner looking to start a career in IT or an experienced professional seeking to enhance your skills, MK Institute has the resources and expertise to help you succeed. Join us and take the first step towards a rewarding career in the dynamic field of information technology.</p>
